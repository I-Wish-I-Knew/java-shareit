...
public class BookingController {
    ...
    @GetMapping
    public ResponseEntity<List<BookingDtoInfo>> getAllByBookerAndState(@RequestParam(required = false, defaultValue = "ALL") State state,
    ...
    @GetMapping("/owner")
    public ResponseEntity<List<BookingDtoInfo>> getAllByOwnerAndState(@RequestParam(required = false, defaultValue = "ALL") State state,
                                                                      @RequestHeader("X-Sharer-User-Id") Long ownerId,
                                                                      @PositiveOrZero @RequestParam(value = "from",
                                                                              defaultValue = "0") Integer from,
                                                                      @Positive @RequestParam(value = "size",
