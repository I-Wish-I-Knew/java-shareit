...
class BookingStorageTest {
    ...
    void findByItemIdAndBookerIdAndStatusAndEndBefore() {
        ...
        Assertions.assertThat(bookings1).isNotEmpty()
                .hasSize(1)
                .contains(booking1);
        ...
        Assertions.assertThat(bookings2).isNotEmpty()
                .hasSize(1)
                .contains(booking2);
        ...
        Assertions.assertThat(bookings3).isNotEmpty()
                .hasSize(1)
                .contains(booking3);
    }
    ...
    void findLastBooking() {
        ...
        Assertions.assertThat(lastBooking1).isNotEmpty()
                .contains(booking1);
        ...
        Assertions.assertThat(lastBooking2).isNotEmpty()
                .contains(booking2);
        ...
        Assertions.assertThat(lastBooking3).isNotEmpty()
                .contains(booking3);
    }
    ...
    void findNextBooking() {
        ...
        Assertions.assertThat(nextBooking1).isNotEmpty()
                .contains(booking1);
        ...
        Assertions.assertThat(nextBooking2).isNotEmpty()
                .contains(booking2);
        ...
        Assertions.assertThat(nextBooking3).isNotEmpty()
                .contains(booking3);
    }
}