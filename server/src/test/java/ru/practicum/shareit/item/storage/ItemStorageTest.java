...
class ItemStorageTest {
    ...
    void findByIdWhereOwnerIdNot() {
        ...
        Assertions.assertThat(emptyItem).isEmpty();
        Assertions.assertThat(emptyItem2).isEmpty();
        ...
        Assertions.assertThat(item).contains(item1);
        Assertions.assertThat(item2).contains(item3);
    }
    ...
    void findAllByNameOrDescriptionLike() {
        ...
        List<Item> items2 = storage.findAllByNameOrDescriptionLike("TiOn",
                PageRequest.of(page, size, Sort.by(Sort.Direction.ASC, "item_id")));
        Assertions.assertThat(items2).hasSize(1).contains(item2);
    }
    ...
    void findAllByRequestId() {
        ...
        Assertions.assertThat(items).hasSize(2).contains(item1).contains(item2);
    }
}