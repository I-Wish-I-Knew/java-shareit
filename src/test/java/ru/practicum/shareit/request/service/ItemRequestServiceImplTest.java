...
class ItemRequestServiceImplTest {
    ...
    void saveRequest() {
        ...
        final ItemRequestDto savedRequest = service.saveRequest(new ItemRequestDto(), author.getId());
    ...
    void saveRequestWithNotFound() {
        ...
        NotFoundException thrown = assertThrows(NotFoundException.class, () -> {
            service.saveRequest(itemRequestDto, 1L);
        });
    ...
    void getOwn() {
        ...
        final List<ItemRequestDtoInfo> requests = service.getOwn(author.getId());
        ...
        verify(storage, times(1))
                .findAllByAuthorId(author.getId(), ItemRequestServiceImpl.SORT);
    }
    ...
    void getAllPageable() {
        ...
        final List<ItemRequestDtoInfo> requests = service.getAllPageable(author.getId(), 10, 10);
        assertThat(requests).hasSize(1)
                .contains(ItemRequestMapper.toItemRequestDtoInfo(request, Collections.singletonList(item)));
        ...
        verify(storage, atLeast(1))
                .findAllByAuthorIdNot(author.getId(), PageRequest.of(10, 10, ItemRequestServiceImpl.SORT));
    }
