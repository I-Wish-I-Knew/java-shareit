...
class ItemRequestControllerTest {
    ...
    void getOwn() throws Exception {
        when(service.getOwn(anyLong())).thenReturn(Collections.emptyList());
    ...
    void getAllPageable() throws Exception {
        when(service.getAllPageable(anyLong(), anyInt(), anyInt()))
    ...
    void save() throws Exception {
        when(service.saveRequest(any(), anyLong())).thenReturn(requestDto);
