...
class BookingServiceGetAlLTest {
    ...
    void getAllCurrentBookerTest() {
        ...
        assertThat(currentBookerBookingsDtoInfo)
                .hasSameSizeAs(currentBookerBookings)
                .hasSize(1)
                .contains(BookingMapper.convertToBookingDtoInfo(booking5));
        assertThat(currentBookerBookings).contains(booking5);
    }
    ...
    void getAllFutureBookerTest() {
        ...
        assertThat(futureBookerBookingsDtoInfo)
                .hasSameSizeAs(futureBookerBookings)
                .hasSize(1)
                .contains(BookingMapper.convertToBookingDtoInfo(booking2));
        assertThat(futureBookerBookings).contains(booking2);
    }
    ...
    void getAllWaitingOwnerTest() {
        ...
        assertThat(waitingOwnerBookingsDtoInfo)
                .hasSameSizeAs(waitingOwnerBookings)
                .hasSize(1)
                .contains(BookingMapper.convertToBookingDtoInfo(booking2));
        assertThat(waitingOwnerBookings).contains(booking2);
    }
    ...
    void getAllWaitingBookerTest() {
        ...
        assertThat(waitingBookerBookingsDtoInfo)
                .hasSameSizeAs(waitingBookerBookings)
                .hasSize(1)
                .contains(BookingMapper.convertToBookingDtoInfo(booking2));
        assertThat(waitingBookerBookings).contains(booking2);
    }
    ...
    void getAllOwnerTest() {
        ...
        assertThat(allOwnerBookingsDtoInfo)
                .hasSameSizeAs(allOwnerBookings)
                .hasSize(1)
                .contains(BookingMapper.convertToBookingDtoInfo(booking2));
        assertThat(allOwnerBookings).contains(booking2);
    }
